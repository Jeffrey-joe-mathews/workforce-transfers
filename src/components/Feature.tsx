...
export const Feature = ({ id, title, description } : { id:Number, title?:String, description?:String }) => {
  ...
  useEffect(()=>{
    ...
    return (
        <div key={id} className="relative max-w-[450px] border-1 border-black/60 p-5 text-center items-center rounded-xl flex flex-row sm:flex-col justify-center gap-4 hover:bg-gray-200 ">
