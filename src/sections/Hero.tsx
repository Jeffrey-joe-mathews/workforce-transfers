...
export const Hero = () => {
  return (
    <section className="flex h-full md:h-[calc(100vh-80px)] pt pt-0 pb-20 md:pt-4 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#868D2F,#EAEEFE_66%)] items-center justify-center overflow-x-clip" >
